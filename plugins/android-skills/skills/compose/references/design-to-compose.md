...
Modifier order is load-bearing (outer to inner: layout/sizing, then decoration, then interaction). The full rules, patterns, and common mistakes live in `compose/references/modifiers.md` ("Modifier Chain Ordering"). Not duplicated here.
